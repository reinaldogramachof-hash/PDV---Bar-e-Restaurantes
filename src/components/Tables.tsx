      ...
      <div className="space-y-6">
        <div className="flex flex-col lg:flex-row justify-between lg:items-end gap-6">
          <div className="space-y-1">
            ...
            <p className={`text-xs font-bold uppercase tracking-widest ${isDark ? 'text-[#3A3A3C]' : 'text-gray-400'}`}>Gestão operacional do salão</p>
          </div>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4 pt-6 border-t border-current/5">
          ...
          <div className="flex gap-3 w-full sm:w-auto">
            <div className={`flex items-center px-5 py-2.5 rounded-2xl border flex-1 sm:w-64 transition-all focus-within:ring-4 focus-within:ring-[#E85D75]/10 ${isDark ? 'bg-[#1C1C1E] border-[#2C2C2E] focus-within:border-[#E85D75]/40' : 'bg-white border-gray-200 focus-within:border-pink-300 shadow-sm'}`}>
              <Search className={`w-4 h-4 mr-3 ${isDark ? 'text-[#3A3A3C]' : 'text-gray-400'}`} />
            ...
            <button onClick={() => { setIsSelecting(!isSelecting); setSelectedForReservation([]); }} className={`px-6 py-2.5 rounded-2xl font-black uppercase tracking-widest text-[10px] flex items-center gap-2 border transition-all ${isSelecting ? 'bg-red-500 text-white border-red-500 shadow-lg shadow-red-500/30' : 'bg-purple-500 text-white border-purple-500 shadow-lg shadow-purple-500/20'}`}>
            ...
            return (
              ...
              >
                <button
                  ...
                  className={`relative w-full aspect-[1/1.1] flex flex-col items-center justify-center rounded-[3rem] transition-all duration-500 overflow-hidden
